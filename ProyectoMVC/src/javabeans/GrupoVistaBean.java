...
public class GrupoVistaBean {
	...
	public int getFk_carrera_materia() {
		return fk_carrera_materia;
	}
	...
	public void setFk_carrera_materia(int fk_carrera_materia) {
		this.fk_carrera_materia = fk_carrera_materia;
	}
